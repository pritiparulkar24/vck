    ...
    return (
        ...
        <p>
          Vivekanand College stands as a beacon of knowledge and integrity, committed to delivering transformative
           ...
           [City/Area, e.g., Chembur, Mumbai], our college has consistently strived to uphold the highest standards of 
        ...
        <p>
          ...
          strong sense of social responsibility. We aim to nurture individuals who are not only successful in their
        ...
        <hr />
        <p>
          [Briefly describe the college's history - e.g., how it started, key milestones, growth over the years,
           famous alumni if any]. Our journey began with a vision to make quality education available to all, 
           and we continue that legacy today.
        </p>
        <h2>About Vivekanand College</h2>
        <p>
